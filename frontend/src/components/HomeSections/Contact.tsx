                ...
                >
                    ...
                    >
                        ...
                        <input
                            ...
                            className={`w-full px-4 py-3 border rounded-lg focus:outline-none ${errors.email} ? "border-red-500" : "border-gray-300"}`}
                    ...
                    >
                        <button
                            type="submit"
                            className="w-full bg-accent font-semibold py-3 rounded-lg hover:bg-opacity-90 transition-all duration-300"
                        >
                            Kirim Pesan
                        </button>
                    </motion.div>
