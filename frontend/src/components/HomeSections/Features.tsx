...
export default function Features () {
    ...
    return (
        <main className="space-y-32">
            ...
            <section className="bg-[#fffbe6] dark:bg-tertiaryDark p-24 rounded-4xl">
                <div className="mb-16">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mx-auto">
                    <div className="bg-[#fffdd7] dark:bg-gray-700 rounded-3xl shadow-xl p-6 relative">
                        <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-yellow-100 dark:bg-gray-800 px-3 py-1 rounded-full text-sm font-medium shadow">
                            Ambil Foto
                        </div>
                        <img src="/images/foto-masalah.png" alt="Foto Masalah" className="rounded-2xl w-full border-4 border-white dark:border-gray-800 shadow-md object-cover" />
                    ...
                    <div className="bg-[#fffdd7] dark:bg-gray-700 rounded-3xl shadow-xl p-6 relative">
                        ...
                        <img
                            ...
                            alt="Foto Masalah"
                            className="rounded-2xl w-full border-4 border-white dark:border-gray-800 shadow-md object-cover"
                        />
                        <div className="absolute whitespace-nowrap -bottom-4 left-1/2 -translate-x-1/2 bg-background dark:bg-gray-800 px-3 py-1 rounded-full text-sm font-medium shadow-xl">
                            <div className="flex items-center gap-1">
                                <MapPin />
